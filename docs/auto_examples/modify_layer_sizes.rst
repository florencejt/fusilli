...
.. "auto_examples/modify_layer_sizes.py"
...
.. only:: html
    ...
    .. note::
        ...
        :ref:`Go to the end <sphx_glr_download_auto_examples_modify_layer_sizes.py>`
        to download the full example code

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_auto_examples_modify_layer_sizes.py:
...
.. _sphx_glr_download_auto_examples_modify_layer_sizes.py:
