...
params["log"] is set to False. (If set to True, then a weights and biases logger is used.)
"""
...
def plot_loss_curve(params, logger, show=False):
    """
    Plots the loss curve from a CSV file generated by the training process.
    The figure is saved to params["loss_fig_path"] if show is False, otherwise
    ...
    if show:
        ...
        plt.savefig(params["loss_fig_path"] + "/" + csv_name + ".png")
        plt.close()
